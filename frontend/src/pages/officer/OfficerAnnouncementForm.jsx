...
function OfficerAnnouncementForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSubmitError(
        'We could not create the announcement. Please check the form and try again.',
      );
    } finally {
      setSubmitting(false);
    }
      ...
      <div className="officer-form-container">
        ...
        <div className="officer-form-header">
          ...
          <div>
            ...
            <p>
              Share important information, notices and updates
              with students through the Kiangini ICT Centre
              platform.
            </p>
          </div>
        </div>
              ...
              <section className="officer-form-card">
                <div className="officer-card-heading">
                  ...
                  <div>
                    ...
                    <p>
                      Provide the information you want students
                      to see.
                    </p>
                  </div>
                </div>
                ...
                <div className="officer-form-fields">
                  <div className="officer-field">
                    ...
                    <input
                      ...
                      placeholder="e.g. Computer Laboratory Maintenance"
                      maxLength={255}
                      className={
                        errors.title
                          ? 'has-error'
            ...
            <aside className="officer-form-sidebar">
              <section className="officer-form-card">
                <div className="officer-card-heading">
                  ...
                  <div>
                    ...
                    <p>
                      Help students understand the purpose.
                    </p>
                  </div>
                </div>
              ...
              <section className="officer-form-card officer-publish-card">
                ...
                <p className="officer-publish-note">
                  {form.is_published
                    ? 'Students will be able to see this announcement immediately after it is created.'
                    : 'The announcement will remain hidden from students until it is published.'}
                </p>
              </section>
            </aside>
          </div>
...
export default OfficerAnnouncementForm;